...
public class SubjectManagePanelController {
    public static List<List<String>> getSubjectListString(String subjectId,String majorId,String subjectName,String credits){
    ...
    public static List<Subject> sendSearchRequestAndReceiveSubjectList(String subjectId,String majorId,String subjectName,String credits){
